...
#' tested data are generated and ploted on the perimeter of the graph while a
#' Q-Q plot of the actual data is depicted in the center of the graph.
#' 
...
#' p-values are calculated based on the Shapiro-Wilk W-statistic. Function will
#' only work on numeric vectors containing less than or equal to 5000
#' observations.
#' 
#' @param actual.data is a numeric vector. Missing and infinite values are
