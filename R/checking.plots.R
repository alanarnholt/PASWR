#' Checking Plots
#' 
#' Function that creates the three graphs discussed in Sections 11.5.1, 11.5.2,
#' and 11.5.3 that assesses independence, normality, and constant variance
#' 
#' 
#' @param model a linear model object
#' @param n.id the number of points to identify
#' @param COL vector of two colors
#' @note Requires package \pkg{MASS}.
