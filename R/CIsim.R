...
#' intervals for either the population mean, the population variance, or the
...
#' @param parameter If constructing confidence intervals for the population
#' mean or the population variance, \code{parameter} is the population mean
#' (i.e., type is one of either \code{"Mean"} or \code{"Var"}). If constructing
#' confidence intervals for the poulation proportion of successes, the value
#' entered for \code{parameter} represents the population proportion of
#' successes \code{(Pi)}, and as such, must be a number between 0 and 1.
#' @param sigma is the population standard deviation. \code{sigma} is not
#' required if confidence intervals are of type \code{"Pi."}
